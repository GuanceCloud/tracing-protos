...
func (c *eBPFProfilingServiceClient) CollectProfilingData(ctx context.Context, opts ...grpc.CallOption) (EBPFProfilingService_CollectProfilingDataClient, error) {
	stream, err := c.cc.NewStream(ctx, &_EBPFProfilingService_serviceDesc.Streams[0], "/skywalking.v3.EBPFProfilingService/collectProfilingData", opts...)
	if err != nil {
		return nil, err
	}
...
func RegisterEBPFProfilingServiceServer(s grpc.ServiceRegistrar, srv EBPFProfilingServiceServer) {
	s.RegisterService(&_EBPFProfilingService_serviceDesc, srv)
}
...
var _EBPFProfilingService_serviceDesc = grpc.ServiceDesc{
