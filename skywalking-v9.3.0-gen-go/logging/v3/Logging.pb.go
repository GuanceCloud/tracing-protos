...
import (
	...
	v31 "github.com/CodapeWild/dktrace-idl/skywalking-v9.3.0-gen-go/language/agent/v3"
...
type LogData struct {
	...
	// [Optional] **Service Instance**. Each individual workload in the Service
	// group is known as an instance. Like `pods` in Kubernetes, it doesn't need
	// to be a single OS process, however, if you are using instrument agents, an
	// instance is actually a real OS process.
	//
	...
	// [Optional] **Endpoint**. A path in a service for incoming requests, such as
	// an HTTP URI path or a gRPC service class + method signature.
	//
	...
	// The layer of the service and servce instance. If absent, the OAP would set
...
func (x *LogData) GetLayer() string {
	if x != nil {
		return x.Layer
	}
	return ""
...
type TraceContext struct {
	...
	// [Optional] A unique id represents this segment. Other segments could use
	// this id to reference as a child segment.
...
var file_logging_Logging_proto_rawDesc = []byte{
	...
	0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x14, 0x63, 0x6f, 0x6d,
	0x6d, 0x6f, 0x6e, 0x2f, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x22, 0xba, 0x02, 0x0a, 0x07, 0x4c, 0x6f, 0x67, 0x44, 0x61, 0x74, 0x61, 0x12, 0x1c, 0x0a,
	...
	0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f,
	...
	,
	...
	0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x70, 0x61, 0x6e, 0x49, 0x64,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x73, 0x70, 0x61, 0x6e, 0x49, 0x64, 0x22, 0x40,
	0x0a, 0x07, 0x4c, 0x6f, 0x67, 0x54, 0x61, 0x67, 0x73, 0x12, 0x35, 0x0a, 0x04, 0x64, 0x61, 0x74,
	0x61, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x73, 0x6b, 0x79, 0x77, 0x61, 0x6c,
	...
	,
	...
	0x6c, 0x6b, 0x69, 0x6e, 0x67, 0x2d, 0x76, 0x39, 0x2e, 0x33, 0x2e, 0x30, 0x2d, 0x67, 0x65, 0x6e,
	0x2d, 0x67, 0x6f, 0x2f, 0x6c, 0x6f, 0x67, 0x67, 0x69, 0x6e, 0x67, 0x2f, 0x76, 0x33, 0xaa, 0x02,
...
var file_logging_Logging_proto_goTypes = []interface{}{
	...
	(*v31.Commands)(nil),          // 8: skywalking.v3.Commands
}
