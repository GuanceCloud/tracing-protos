...
type BrowserPerfServiceClient interface {
	...
	CollectPerfData(ctx context.Context, in *BrowserPerfData, opts ...grpc.CallOption) (*Commands, error)
...
func (c *browserPerfServiceClient) CollectPerfData(ctx context.Context, in *BrowserPerfData, opts ...grpc.CallOption) (*Commands, error) {
	out := new(Commands)
...
func (x *browserPerfServiceCollectErrorLogsClient) CloseAndRecv() (*Commands, error) {
...
func (x *browserPerfServiceCollectErrorLogsServer) SendAndClose(m *Commands) error {
