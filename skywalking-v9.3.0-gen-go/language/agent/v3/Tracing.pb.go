...
import (
	v3 "github.com/CodapeWild/dktrace-idl/skywalking-v9.3.0-gen-go/common/v3"
...
//
// When an RPC is being traced by the in-process language agent, a span would be
// reported by the client-side agent. And the rover would be aware of this RPC
// due to the existing tracing header. Then, the rover agent collects extra
// information from the OS level to provide assistance information to diagnose
// network performance.
type SpanAttachedEvent struct {
	...
	// NANO-SECOND is required here. Because the attached event happens in the OS
	// syscall level, most of them are executed rapidly.
	...
	// Each statistic provides a name(metric name) to represent the name, and an
	// int64/long as the value.
	Summary []*v3.KeyIntValuePair `protobuf:"bytes,5,rep,name=summary,proto3" json:"summary,omitempty"`
	// Refer to a trace context decoded from `sw8` header through network, such as
	// HTTP header, MQ metadata
...
type SpanAttachedEvent_SpanReference struct {
	...
	TraceId string `protobuf:"bytes,2,opt,name=traceId,proto3" json:"traceId,omitempty"`
	// A unique id represents this segment. Other segments could use this id to
	// reference as a child segment. [Optional] when this span reference
...
var file_language_agent_Tracing_proto_rawDesc = []byte{
	...
	,
	...
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x55, 0x73, 0x65, 0x64, 0x41, 0x74, 0x50, 0x65, 0x65, 0x72,
	0x22, 0x9b, 0x04, 0x0a, 0x0a, 0x53, 0x70, 0x61, 0x6e, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x12,
	...
	0x69, 0x6d, 0x65, 0x12, 0x33, 0x0a, 0x04, 0x72, 0x65, 0x66, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x1f, 0x2e, 0x73, 0x6b, 0x79, 0x77, 0x61, 0x6c, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x76,
	0x33, 0x2e, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e,
	...
	,
	...
	,
	...
	,
	...
	0x70, 0x61, 0x6e, 0x41, 0x74, 0x74, 0x61, 0x63, 0x68, 0x65, 0x64, 0x45, 0x76, 0x65, 0x6e, 0x74,
	0x2e, 0x53, 0x70, 0x61, 0x6e, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x54, 0x79,
	0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x74, 0x72, 0x61, 0x63,
	...
	,
	...
	0x74, 0x2e, 0x76, 0x33, 0x50, 0x01, 0x5a, 0x4c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	0x6f, 0x6d, 0x2f, 0x43, 0x6f, 0x64, 0x61, 0x70, 0x65, 0x57, 0x69, 0x6c, 0x64, 0x2f, 0x64, 0x6b,
	0x74, 0x72, 0x61, 0x63, 0x65, 0x2d, 0x69, 0x64, 0x6c, 0x2f, 0x73, 0x6b, 0x79, 0x77, 0x61, 0x6c,
	0x6b, 0x69, 0x6e, 0x67, 0x2d, 0x76, 0x39, 0x2e, 0x33, 0x2e, 0x30, 0x2d, 0x67, 0x65, 0x6e, 0x2d,
	0x67, 0x6f, 0x2f, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x2f, 0x61, 0x67, 0x65, 0x6e,
	0x74, 0x2f, 0x76, 0x33, 0xaa, 0x02, 0x1d, 0x53, 0x6b, 0x79, 0x57, 0x61, 0x6c, 0x6b, 0x69, 0x6e,
	0x67, 0x2e, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f,
	0x6c, 0x2e, 0x56, 0x33, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_language_agent_Tracing_proto_goTypes = []interface{}{
	...
	(*Commands)(nil),                         // 15: skywalking.v3.Commands
}
...
func file_language_agent_Tracing_proto_init() {
	...
	file_common_Command_proto_init()
	if !protoimpl.UnsafeEnabled {
