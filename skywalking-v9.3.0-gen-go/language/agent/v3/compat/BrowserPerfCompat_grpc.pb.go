...
type BrowserPerfServiceClient interface {
	...
	CollectPerfData(ctx context.Context, in *v3.BrowserPerfData, opts ...grpc.CallOption) (*v3.Commands, error)
...
func (c *browserPerfServiceClient) CollectPerfData(ctx context.Context, in *v3.BrowserPerfData, opts ...grpc.CallOption) (*v3.Commands, error) {
	out := new(v3.Commands)
...
type BrowserPerfServiceServer interface {
	// report once per page
	CollectPerfData(context.Context, *v3.BrowserPerfData) (*v3.Commands, error)
	// report one or more error logs for pages, could report multiple times.
...
func (UnimplementedBrowserPerfServiceServer) CollectPerfData(context.Context, *v3.BrowserPerfData) (*v3.Commands, error) {
