...
type TraceSegmentReportServiceClient interface {
	...
	CollectInSync(ctx context.Context, in *v3.SegmentCollection, opts ...grpc.CallOption) (*v3.Commands, error)
}
...
func (c *traceSegmentReportServiceClient) CollectInSync(ctx context.Context, in *v3.SegmentCollection, opts ...grpc.CallOption) (*v3.Commands, error) {
	out := new(v3.Commands)
...
type TraceSegmentReportServiceServer interface {
	...
	// very similar with streaming report, the performance of the network and
	// client side are affected
	CollectInSync(context.Context, *v3.SegmentCollection) (*v3.Commands, error)
...
func (UnimplementedTraceSegmentReportServiceServer) CollectInSync(context.Context, *v3.SegmentCollection) (*v3.Commands, error) {
