...
type JVMMetricReportServiceClient interface {
	Collect(ctx context.Context, in *v3.JVMMetricCollection, opts ...grpc.CallOption) (*v3.Commands, error)
}
...
func (c *jVMMetricReportServiceClient) Collect(ctx context.Context, in *v3.JVMMetricCollection, opts ...grpc.CallOption) (*v3.Commands, error) {
	out := new(v3.Commands)
...
type JVMMetricReportServiceServer interface {
	Collect(context.Context, *v3.JVMMetricCollection) (*v3.Commands, error)
...
func (UnimplementedJVMMetricReportServiceServer) Collect(context.Context, *v3.JVMMetricCollection) (*v3.Commands, error) {
