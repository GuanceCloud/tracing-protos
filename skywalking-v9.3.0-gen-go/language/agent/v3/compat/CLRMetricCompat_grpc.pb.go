...
type CLRMetricReportServiceClient interface {
	Collect(ctx context.Context, in *v3.CLRMetricCollection, opts ...grpc.CallOption) (*v3.Commands, error)
}
...
func (c *cLRMetricReportServiceClient) Collect(ctx context.Context, in *v3.CLRMetricCollection, opts ...grpc.CallOption) (*v3.Commands, error) {
	out := new(v3.Commands)
...
type CLRMetricReportServiceServer interface {
	Collect(context.Context, *v3.CLRMetricCollection) (*v3.Commands, error)
...
func (UnimplementedCLRMetricReportServiceServer) Collect(context.Context, *v3.CLRMetricCollection) (*v3.Commands, error) {
