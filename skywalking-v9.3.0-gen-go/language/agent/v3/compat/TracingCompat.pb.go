...
var file_language_agent_TracingCompat_proto_rawDesc = []byte{
	...
	0x17, 0x2e, 0x73, 0x6b, 0x79, 0x77, 0x61, 0x6c, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x33, 0x2e,
	0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x73, 0x22, 0x00, 0x42, 0xbd, 0x01, 0x0a, 0x3a, 0x6f,
	...
	0x76, 0x33, 0x2e, 0x63, 0x6f, 0x6d, 0x70, 0x61, 0x74, 0x50, 0x01, 0x5a, 0x53, 0x67, 0x69, 0x74,
	...
	0x6b, 0x79, 0x77, 0x61, 0x6c, 0x6b, 0x69, 0x6e, 0x67, 0x2d, 0x76, 0x39, 0x2e, 0x33, 0x2e, 0x30,
...
var file_language_agent_TracingCompat_proto_goTypes = []interface{}{
	(*v3.SegmentObject)(nil),     // 0: skywalking.v3.SegmentObject
	(*v3.SegmentCollection)(nil), // 1: skywalking.v3.SegmentCollection
	(*v3.Commands)(nil),          // 2: skywalking.v3.Commands
}
var file_language_agent_TracingCompat_proto_depIdxs = []int32{
	0, // 0: TraceSegmentReportService.collect:input_type -> skywalking.v3.SegmentObject
	1, // 1: TraceSegmentReportService.collectInSync:input_type -> skywalking.v3.SegmentCollection
	2, // 2: TraceSegmentReportService.collect:output_type -> skywalking.v3.Commands
	2, // 3: TraceSegmentReportService.collectInSync:output_type -> skywalking.v3.Commands
