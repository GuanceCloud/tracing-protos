...
func (c *spanAttachedEventReportServiceClient) Collect(ctx context.Context, opts ...grpc.CallOption) (SpanAttachedEventReportService_CollectClient, error) {
	stream, err := c.cc.NewStream(ctx, &_SpanAttachedEventReportService_serviceDesc.Streams[0], "/skywalking.v3.SpanAttachedEventReportService/collect", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *spanAttachedEventReportServiceCollectClient) CloseAndRecv() (*Commands, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(Commands)
...
func RegisterSpanAttachedEventReportServiceServer(s grpc.ServiceRegistrar, srv SpanAttachedEventReportServiceServer) {
	s.RegisterService(&_SpanAttachedEventReportService_serviceDesc, srv)
}
...
func (x *spanAttachedEventReportServiceCollectServer) SendAndClose(m *Commands) error {
	return x.ServerStream.SendMsg(m)
}
...
var _SpanAttachedEventReportService_serviceDesc = grpc.ServiceDesc{
