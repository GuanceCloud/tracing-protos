...
//
// When the agent communicates with the OAP side using gRPC, the OAP uses
// Command to return the data content to the Agent.
//
...
type Command struct {
	...
	Args []*v3.KeyStringValuePair `protobuf:"bytes,2,rep,name=args,proto3" json:"args,omitempty"`
}
...
func (x *Command) GetArgs() []*v3.KeyStringValuePair {
	if x != nil {
		return x.Args
	}
	return nil
...
var file_common_Command_proto_rawDesc = []byte{
	...
	0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x73, 0x42, 0x9d, 0x01, 0x0a, 0x2b, 0x6f, 0x72, 0x67, 0x2e, 0x61,
	...
	0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x33, 0x50, 0x01, 0x5a, 0x4c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
