...
type ManagementServiceClient interface {
	...
	ReportInstanceProperties(ctx context.Context, in *InstanceProperties, opts ...grpc.CallOption) (*v3old.Commands, error)
	...
	KeepAlive(ctx context.Context, in *InstancePingPkg, opts ...grpc.CallOption) (*v3old.Commands, error)
}
...
func (c *managementServiceClient) ReportInstanceProperties(ctx context.Context, in *InstanceProperties, opts ...grpc.CallOption) (*v3old.Commands, error) {
...
func (c *managementServiceClient) KeepAlive(ctx context.Context, in *InstancePingPkg, opts ...grpc.CallOption) (*v3old.Commands, error) {
	out := new(v3old.Commands)
...
type ManagementServiceServer interface {
	// Report custom properties of a service instance.
	ReportInstanceProperties(context.Context, *InstanceProperties) (*v3old.Commands, error)
	// Keep the instance alive in the backend analysis.
	// Only recommend to do separate keepAlive report when no trace and metrics
	// needs to be reported. Otherwise, it is duplicated.
	KeepAlive(context.Context, *InstancePingPkg) (*v3old.Commands, error)
...
func (UnimplementedManagementServiceServer) ReportInstanceProperties(context.Context, *InstanceProperties) (*v3old.Commands, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReportInstanceProperties not implemented")
}
func (UnimplementedManagementServiceServer) KeepAlive(context.Context, *InstancePingPkg) (*v3old.Commands, error) {
