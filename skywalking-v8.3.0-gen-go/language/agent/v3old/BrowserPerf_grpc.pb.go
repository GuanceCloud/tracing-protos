...
type BrowserPerfServiceClient interface {
	...
	CollectPerfData(ctx context.Context, in *BrowserPerfData, opts ...grpc.CallOption) (*v3old.Commands, error)
...
func (c *browserPerfServiceClient) CollectPerfData(ctx context.Context, in *BrowserPerfData, opts ...grpc.CallOption) (*v3old.Commands, error) {
...
func (x *browserPerfServiceCollectErrorLogsClient) CloseAndRecv() (*v3old.Commands, error) {
...
type BrowserPerfServiceServer interface {
	// report once per page
	CollectPerfData(context.Context, *BrowserPerfData) (*v3old.Commands, error)
	// report one or more error logs for pages, could report multiple times.
...
func (UnimplementedBrowserPerfServiceServer) CollectPerfData(context.Context, *BrowserPerfData) (*v3old.Commands, error) {
...
func (x *browserPerfServiceCollectErrorLogsServer) SendAndClose(m *v3old.Commands) error {
