...
type TraceSegmentReportServiceClient interface {
	...
	CollectInSync(ctx context.Context, in *SegmentCollection, opts ...grpc.CallOption) (*v3old.Commands, error)
}
...
func (x *traceSegmentReportServiceCollectClient) CloseAndRecv() (*v3old.Commands, error) {
...
func (c *traceSegmentReportServiceClient) CollectInSync(ctx context.Context, in *SegmentCollection, opts ...grpc.CallOption) (*v3old.Commands, error) {
...
type TraceSegmentReportServiceServer interface {
	...
	// very similar with streaming report, the performance of the network and
	// client side are affected
	CollectInSync(context.Context, *SegmentCollection) (*v3old.Commands, error)
...
func (UnimplementedTraceSegmentReportServiceServer) CollectInSync(context.Context, *SegmentCollection) (*v3old.Commands, error) {
...
func (x *traceSegmentReportServiceCollectServer) SendAndClose(m *v3old.Commands) error {
