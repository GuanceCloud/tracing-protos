...
type ProfileTaskClient interface {
	...
	GetProfileTaskCommands(ctx context.Context, in *ProfileTaskCommandQuery, opts ...grpc.CallOption) (*v3old.Commands, error)
	...
	ReportTaskFinish(ctx context.Context, in *ProfileTaskFinishReport, opts ...grpc.CallOption) (*v3old.Commands, error)
}
...
func (c *profileTaskClient) GetProfileTaskCommands(ctx context.Context, in *ProfileTaskCommandQuery, opts ...grpc.CallOption) (*v3old.Commands, error) {
	out := new(v3old.Commands)
...
type ProfileTask_CollectSnapshotClient interface {
	...
	CloseAndRecv() (*v3old.Commands, error)
	grpc.ClientStream
}
...
func (x *profileTaskCollectSnapshotClient) CloseAndRecv() (*v3old.Commands, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(v3old.Commands)
...
func (c *profileTaskClient) ReportTaskFinish(ctx context.Context, in *ProfileTaskFinishReport, opts ...grpc.CallOption) (*v3old.Commands, error) {
	out := new(v3old.Commands)
...
type ProfileTaskServer interface {
	// query all sniffer need to execute profile task commands
	GetProfileTaskCommands(context.Context, *ProfileTaskCommandQuery) (*v3old.Commands, error)
	// collect dumped thread snapshot
	CollectSnapshot(ProfileTask_CollectSnapshotServer) error
	// report profiling task finished
	ReportTaskFinish(context.Context, *ProfileTaskFinishReport) (*v3old.Commands, error)
...
func (UnimplementedProfileTaskServer) GetProfileTaskCommands(context.Context, *ProfileTaskCommandQuery) (*v3old.Commands, error) {
...
func (UnimplementedProfileTaskServer) ReportTaskFinish(context.Context, *ProfileTaskFinishReport) (*v3old.Commands, error) {
...
type ProfileTask_CollectSnapshotServer interface {
	SendAndClose(*v3old.Commands) error
...
func (x *profileTaskCollectSnapshotServer) SendAndClose(m *v3old.Commands) error {
